...
public class DisplayGui extends GuiScreen {
    ...
    public void initGui() {
        ...
        urlTbx = new GuiTextField(
                0,
                fontRenderer,
                x + 10, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 1.5),
        ...
        if (tile.caps.resizes()) {
            widthTbx = new GuiTextField(
                    1,
                    fontRenderer,
                    x + 10, (int) (y + 10 + fontRenderer.FONT_HEIGHT * 3.4),
                    WIDTH / 3, 18
            ) {
                @Override
            ...
            heightTbx = new GuiTextField(
                    2,
                    fontRenderer,
                    x + 10 + 5 + 24 + WIDTH / 3, (int) (y + 10 + fontRenderer.FONT_HEIGHT * 3.4),
                    WIDTH / 3, 18
            ) {
                @Override
                public void writeText(String text) {
            ...
            widgets.add(new IconButton(
                    ...
                    x + 10 + 3 + WIDTH / 3, (int) (y + 10 - 2 + fontRenderer.FONT_HEIGHT * 3.5),
                    20, 20,
                    button -> {
            ...
            widgets.add(new IconButton(
                    ...
                    x + 10 + 8 + 24 + 2 * WIDTH / 3, (int) (y + 10 - 2 + fontRenderer.FONT_HEIGHT * 3.5),
                    20, 20,
                    button -> {
                        if (tile.display != null) {
                            try {
            ...
            widgets.add(new Slider(
                    x + 10 + 16 + 5, y + 10 + fontRenderer.FONT_HEIGHT * 7,
                    WIDTH / 2, 16,
            ...
            widgets.add(new PositionWidget(
                    this,
                    (int)(x + 10 + WIDTH * 0.65), y + 10 + fontRenderer.FONT_HEIGHT * 7,
        ...
        if (tile.caps.projects()) {
            widgets.add(new Slider(
                    x + 10 + 16 + 5, y + 10 + fontRenderer.FONT_HEIGHT * 15,
                    WIDTH / 3, 16,
        ...
        widgets.add(new Slider(
                x + 10 + 16 * 2 + 5 + WIDTH / 3, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 20.5),
                WIDTH / 3, 16,
        ...
        loopButton = new IconButton(
                ...
                x + 10, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 22.5),
                20, 20,
            ...
            public List<String> getFormattedTooltip() {
                return Collections.singletonList(
                        I18n.format(icon.tooltipKey, tile.data.loop ? ChatFormatting.GREEN + "enabled" : ChatFormatting.RED + "disabled")
                );
            }
        };
        ...
        playPauseButton = new IconButton(
                ...
                x + 10 + 24, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 22.5),
                20, 20,
        ...
        widgets.add(new IconButton(
                ...
                x + 10 + 24 * 2, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 22.5),
                20, 20,
                button -> tile.setStop()
        ));
        seekbar = new SeekbarSlider(
                x + 10 + 24 * 3, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 22.5),
                2 * WIDTH / 3 - 35, 20,
        ...
        saveBtn = new Button(
                ...
                x + 10, y + 10 + fontRenderer.FONT_HEIGHT * 25,
                WIDTH / 5, 16,
                button -> PacketDispatcher.wrapper.sendToServer(new SyncPacket(
                        tile.getWorld().provider.getDimension(), tile.getPos().getX(), tile.getPos().getY(), tile.getPos().getZ(),
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        widgets.forEach(widget -> widget.render(fontRenderer, mouseX, mouseY, partialTicks));

        fontRenderer.drawString(I18n.format("waterframes.gui.label.url"), x + 10, y + 10, 0xFFFFFF);
        fontRenderer.drawString(I18n.format("waterframes.gui.label.textureSettings"), x + 10, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 5.5 + 4), 0xFFFFFF);
        fontRenderer.drawString(I18n.format("waterframes.gui.label.mediaSettings"), x + 10, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 17.5), 0xFFFFFF);

        if (tile.caps.resizes()) {
            IconStyles.renderIcon(this, IconStyles.ROTATION, x + 10, y + 10 + fontRenderer.FONT_HEIGHT * 7, mouseX, mouseY, partialTicks);
        }
        IconStyles.renderIcon(this, IconStyles.TRANSPARENCY, x + 10, y + 10 + fontRenderer.FONT_HEIGHT * 9, mouseX, mouseY, partialTicks);
        IconStyles.renderIcon(this, IconStyles.BRIGHTNESS, x + 10, y + 10 + fontRenderer.FONT_HEIGHT * 11, mouseX, mouseY, partialTicks);
        IconStyles.renderIcon(this, IconStyles.DISTANCE, x + 10, y + 10 + fontRenderer.FONT_HEIGHT * 13, mouseX, mouseY, partialTicks);
        if (tile.caps.projects()) {
            IconStyles.renderIcon(this, IconStyles.PROJECTION_DISTANCE, x + 10, y + 10 + fontRenderer.FONT_HEIGHT * 15, mouseX, mouseY, partialTicks);
        }
        IconStyles.renderIcon(this, IconStyles.getVolumeIcon(volume, tile.data.muted), x + 10, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 18.5), mouseX, mouseY, partialTicks);
        IconStyles.renderIcon(this, IconStyles.VOLUME_RANGE_MIN, x + 10, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 20.5), mouseX, mouseY, partialTicks);
        IconStyles.renderIcon(this, IconStyles.VOLUME_RANGE_MAX, x + 10 + 16 + 5 + WIDTH / 3, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 20.5), mouseX, mouseY, partialTicks);
        ...
        if (tile.caps.resizes()) {
            renderIconTooltip(IconStyles.ROTATION, x + 10, y + 10 + fontRenderer.FONT_HEIGHT * 7, mouseX, mouseY, partialTicks);
        }
        renderIconTooltip(IconStyles.TRANSPARENCY, x + 10, y + 10 + fontRenderer.FONT_HEIGHT * 9, mouseX, mouseY, partialTicks);
        renderIconTooltip(IconStyles.BRIGHTNESS, x + 10, y + 10 + fontRenderer.FONT_HEIGHT * 11, mouseX, mouseY, partialTicks);
        renderIconTooltip(IconStyles.DISTANCE, x + 10, y + 10 + fontRenderer.FONT_HEIGHT * 13, mouseX, mouseY, partialTicks);
        if (tile.caps.projects()) {
            renderIconTooltip(IconStyles.PROJECTION_DISTANCE, x + 10, y + 10 + fontRenderer.FONT_HEIGHT * 15, mouseX, mouseY, partialTicks);
        }
        renderIconTooltip(IconStyles.getVolumeIcon(volume, tile.data.muted), x + 10, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 18.5), mouseX, mouseY, partialTicks);
        renderIconTooltip(IconStyles.VOLUME_RANGE_MIN, x + 10, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 20.5), mouseX, mouseY, partialTicks);
        renderIconTooltip(IconStyles.VOLUME_RANGE_MAX, x + 10 + 16 + 5 + WIDTH / 3, (int)(y + 10 + fontRenderer.FONT_HEIGHT * 20.5), mouseX, mouseY, partialTicks);
    }
    ...
    private void renderIconTooltip(IconStyles.Icon icon, int x, int y, int mouseX, int mouseY, float partialTicks) {
        if(mouseX >= x && mouseX <= x + icon.width && mouseY >= y && mouseY <= y + icon.height) {
            drawHoveringText(Collections.singletonList(I18n.format(icon.tooltipKey)), mouseX, mouseY, fontRenderer);
            GL11.glDisable(GL11.GL_LIGHTING);
        }
    }
