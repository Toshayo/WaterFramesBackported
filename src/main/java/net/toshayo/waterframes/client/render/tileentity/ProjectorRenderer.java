...
public class ProjectorRenderer extends DisplayRenderer {
    private static final ResourceLocation PROJECTOR_TEXTURE = new ResourceLocation(WaterFramesMod.MOD_ID, "textures/block/projector.png");
    ...
    public void render(DisplayTileEntity tile, double x, double y, double z, float partialTicks, int p_192841_9_, float p_192841_10_) {
        renderModel(PROJECTOR_TEXTURE, PROJECTOR_MODEL, x, y, z, tile.blockFacing, true);
