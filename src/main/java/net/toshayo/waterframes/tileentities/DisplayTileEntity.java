...
public abstract class DisplayTileEntity extends TileEntity implements SimpleComponent, ITickable {
    ...
    public void setActive(boolean mode) {
        PacketDispatcher.wrapper.sendToServer(new ActivePacket(world.provider.getDimension(), pos.getX(), pos.getY(), pos.getZ(), mode));
    }

    public void setMute(boolean mode) {
        PacketDispatcher.wrapper.sendToServer(new MutePacket(world.provider.getDimension(), pos.getX(), pos.getY(), pos.getZ(), mode));
    }

    public void setPause(boolean pause) {
        PacketDispatcher.wrapper.sendToServer(new PausePacket(world.provider.getDimension(), pos.getX(), pos.getY(), pos.getZ(), pause, this.data.tick));
    }

    public void setStop() {
        PacketDispatcher.wrapper.sendToServer(new PausePacket(world.provider.getDimension(), pos.getX(), pos.getY(), pos.getZ(), true, 0));
    }

    public void volumeUp() {
        PacketDispatcher.wrapper.sendToServer(new VolumePacket(world.provider.getDimension(), pos.getX(), pos.getY(), pos.getZ(), this.data.volume + 5));
    }
    ...
    public void fastFoward() {
        PacketDispatcher.wrapper.sendToServer(new TimePacket(world.provider.getDimension(), pos.getX(), pos.getY(), pos.getZ(), Math.min(data.tick + MathAPI.msToTick(5000), this.data.tickMax), this.data.tickMax));
    }
    ...
    public void loop(boolean loop) {
        PacketDispatcher.wrapper.sendToServer(new LoopPacket(world.provider.getDimension(), pos.getX(), pos.getY(), pos.getZ(), loop));
    }
    ...
    public void update() {
        ...
        if (this.isClient()) {
            ...
            if (display != null && display.canTick()) {
                display.tick(pos.getX(), pos.getY(), pos.getZ());
            }
        }
    }
    ...
    public Object[] setAutoWidth(Context context, Arguments args) {
        ...
        RequestDisplayInfoPacket.PENDING_RESIZES.put(Triple.of(pos.getX(), pos.getY(), pos.getZ()), "wa");
        PacketDispatcher.wrapper.sendTo(new RequestDisplayInfoPacket(world.provider.getDimension(), pos.getX(), pos.getY(), pos.getZ(), 0, 0), ((EntityPlayerMP) world.playerEntities.get(0)));
    ...
    public Object[] setAutoHeight(Context context, Arguments args) {
        ...
        RequestDisplayInfoPacket.PENDING_RESIZES.put(Triple.of(pos.getX(), pos.getY(), pos.getZ()), "ha");
        PacketDispatcher.wrapper.sendTo(new RequestDisplayInfoPacket(world.provider.getDimension(), pos.getX(), pos.getY(), pos.getZ(), 0, 0), ((EntityPlayerMP) world.playerEntities.get(0)));
        return new Object[] { true };
    }
}
